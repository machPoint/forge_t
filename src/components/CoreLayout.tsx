...
import CoreViewer from "./core/CoreViewer";
import CoreInsights from "./core/CoreInsights";
...
const CoreLayout: React.FC = () => {
  ...
  const [coreEntries, setCoreEntries] = useState<CoreEntry[]>([]);
  ...
  useEffect(() => {
    ...
    // Mock core data for now
    setCoreEntries([
      {
        id: "1",
        title: "Project Progress Update",
        content: "Made significant progress on the OPAL integration project...",
        summary: "Completed authentication system and started working on core management features.",
