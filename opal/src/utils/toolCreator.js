 ...
 */
function createTool(configs, wss, toolDefinition) {
 ...
 */
function createTools(configs, wss, toolDefinitions) {
  ...
  return toolDefinitions.map(def => createTool(configs, wss, def));
}
